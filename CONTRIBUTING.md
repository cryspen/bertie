...
Before contributing, please read the [Code of Conduct](https://github.com/cryspen/bertie/CODE_OF_CONDUCT.md)
and [Contributor Agreement](CLA.md) carefully.
...
We use issues (and projects) to organise and prioritise work items.
...
If you are looking to contribute, picking issues with a high priority is preferred.
