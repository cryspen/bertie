...
let check_supported_versions (client_hello: t_Slice u8) =
  match t13.Tls13utils.check_length_encoding_u8_slice client_hello with
  | Core.Result.Result_Ok _ ->
    t13.Tls13utils.check_mem (Rust_primitives.unsize (let list =
              [t13.Tls13utils.v_U8 3uy <: u8; t13.Tls13utils.v_U8 4uy <: u8]
            in
...
let check_psk_shared_key (v__algs: t13.Tls13crypto.t_Algorithms) (ch: t_Slice u8) =
  match t13.Tls13utils.length_u16_encoded ch with
    ...
    (match
      ...
      | Core.Result.Result_Ok len_tkt ->
        ...
        then
          ...
          | Core.Result.Result_Err err ->
            Core.Result.Result_Err err <: Core.Result.t_Result Prims.unit u8
        else t13.Tls13utils.tlserr (t13.Tls13utils.parse_failed () <: u8)
      | Core.Result.Result_Err err ->
        Core.Result.Result_Err err <: Core.Result.t_Result Prims.unit u8)
  | Core.Result.Result_Err err -> Core.Result.Result_Err err <: Core.Result.t_Result Prims.unit u8

let check_server_psk_shared_key (v__algs: t13.Tls13crypto.t_Algorithms) (b: t_Slice u8) =
  t13.Tls13utils.check_eq_slice (Rust_primitives.unsize (let list =
            [t13.Tls13utils.v_U8 0uy <: u8; t13.Tls13utils.v_U8 0uy <: u8]
          in
          FStar.Pervasives.assert_norm (Prims.eq2 (List.Tot.length list) 2);
          Rust_primitives.Hax.array_of_list 2 list)
      <:
...
let check_server_supported_version (v__algs: t13.Tls13crypto.t_Algorithms) (b: t_Slice u8) =
  t13.Tls13utils.check_eq_slice (Rust_primitives.unsize (let list =
            [t13.Tls13utils.v_U8 3uy <: u8; t13.Tls13utils.v_U8 4uy <: u8]
          in
          FStar.Pervasives.assert_norm (Prims.eq2 (List.Tot.length list) 2);
  ...
  | Core.Result.Result_Ok _ ->
    (match t13.Tls13crypto.impl__Algorithms__signature_algorithm algs with
      | Core.Result.Result_Ok hoist24 ->
        t13.Tls13utils.check_mem (t13.Tls13utils.impl__Bytes__as_raw hoist24 <: t_Slice u8)
          (ch.[ {
                Core.Ops.Range.f_start = sz 2;
                Core.Ops.Range.f_end = Core.Slice.impl__len ch <: usize
              }
  ...
  | Core.Result.Result_Ok _ ->
    (match t13.Tls13crypto.impl__Algorithms__supported_group algs with
      | Core.Result.Result_Ok hoist26 ->
        t13.Tls13utils.check_mem (t13.Tls13utils.impl__Bytes__as_raw hoist26 <: t_Slice u8)
          (ch.[ {
                Core.Ops.Range.f_start = sz 2;
                Core.Ops.Range.f_end = Core.Slice.impl__len ch <: usize
              }
...
let parse_ecdsa_signature (sig: t13.Tls13utils.t_Bytes) =
  if (t13.Tls13utils.impl__Bytes__len sig <: usize) <. sz 4
  then
    Core.Result.Result_Err (t13.Tls13utils.parse_failed ())
    <:
    Core.Result.t_Result t13.Tls13utils.t_Bytes u8
    ...
    match
      t13.Tls13utils.check_eq (t13.Tls13utils.bytes1 48uy <: t13.Tls13utils.t_Bytes)
        (t13.Tls13utils.impl__Bytes__slice_range sig
    ...
    | Core.Result.Result_Ok _ ->
      (match
          t13.Tls13utils.check_length_encoding_u8 (t13.Tls13utils.impl__Bytes__slice_range sig
                ({
                    Core.Ops.Range.f_start = sz 1;
                    Core.Ops.Range.f_end = t13.Tls13utils.impl__Bytes__len sig <: usize
                  }
                  <:
                  Core.Ops.Range.t_Range usize)
              <:
        ...
        | Core.Result.Result_Ok _ ->
          (match
              t13.Tls13utils.check_eq (t13.Tls13utils.bytes1 2uy <: t13.Tls13utils.t_Bytes)
                (t13.Tls13utils.impl__Bytes__slice_range sig
                  ...
                  (match check_r_len rlen with
                    | Core.Result.Result_Ok _ ->
                      let r:t13.Tls13utils.t_Bytes =
                        t13.Tls13utils.impl__Bytes__slice sig
                          ((sz 4 +! rlen <: usize) -! sz 32 <: usize)
                          (sz 32)
                      in
                      if
                        (t13.Tls13utils.impl__Bytes__len sig <: usize) <.
                      ...
                      then
                        ...
                        (match
                            t13.Tls13utils.check_eq (t13.Tls13utils.bytes1 2uy
                                <:
                                t13.Tls13utils.t_Bytes)
                              (t13.Tls13utils.impl__Bytes__slice_range sig
                                  ({
                          ...
                          | Core.Result.Result_Ok _ ->
                            (match
                                t13.Tls13utils.check_length_encoding_u8 (t13.Tls13utils.impl__Bytes__slice_range
                                      sig
                                      ({
                              ...
                              | Core.Result.Result_Ok _ ->
                                let s:t13.Tls13utils.t_Bytes =
                                  t13.Tls13utils.impl__Bytes__slice sig
                                    ((t13.Tls13utils.impl__Bytes__len sig <: usize) -! sz 32
                                      <:
                                      usize)
                                    (sz 32)
                                in
                                Core.Result.Result_Ok (t13.Tls13utils.impl__Bytes__concat r s)
                                <:
                                Core.Result.t_Result t13.Tls13utils.t_Bytes u8
                              | Core.Result.Result_Err err ->
                                Core.Result.Result_Err err
...
let build_server_name (name: t13.Tls13utils.t_Bytes) =
  match
    t13.Tls13utils.encode_length_u16 (Core.Clone.f_clone name <: t13.Tls13utils.t_Bytes)
  with
  | Core.Result.Result_Ok hoist50 ->
    (match
        t13.Tls13utils.encode_length_u16 (t13.Tls13utils.impl__Bytes__prefix hoist50
              (Rust_primitives.unsize build_server_name__PREFIX2 <: t_Slice u8)
            <:
            t13.Tls13utils.t_Bytes)
      with
      | Core.Result.Result_Ok hoist53 ->
        (match t13.Tls13utils.encode_length_u16 hoist53 with
          | Core.Result.Result_Ok hoist55 ->
            Core.Result.Result_Ok
            (t13.Tls13utils.impl__Bytes__prefix hoist55
...
let key_shares (algs: t13.Tls13crypto.t_Algorithms) (gx: t13.Tls13utils.t_Bytes) =
  ...
  | Core.Result.Result_Ok hoist58 ->
    (match t13.Tls13utils.encode_length_u16 gx with
      | Core.Result.Result_Ok hoist57 ->
        let ks:t13.Tls13utils.t_Bytes = t13.Tls13utils.impl__Bytes__concat hoist58 hoist57 in
        (match t13.Tls13utils.encode_length_u16 ks with
          | Core.Result.Result_Ok hoist59 ->
            (match t13.Tls13utils.encode_length_u16 hoist59 with
              | Core.Result.Result_Ok hoist61 ->
                Core.Result.Result_Ok
                (t13.Tls13utils.impl__Bytes__prefix hoist61
  ...
  | Core.Result.Result_Ok hoist64 ->
    (match t13.Tls13utils.encode_length_u16 gx with
      | Core.Result.Result_Ok hoist63 ->
        let ks:t13.Tls13utils.t_Bytes = t13.Tls13utils.impl__Bytes__concat hoist64 hoist63 in
        (match t13.Tls13utils.encode_length_u16 ks with
          | Core.Result.Result_Ok hoist65 ->
            Core.Result.Result_Ok
            (t13.Tls13utils.impl__Bytes__concat (t13.Tls13utils.bytes2 0uy 51uy
                  <:
                  t13.Tls13utils.t_Bytes)
                hoist65)
            <:
...
let server_pre_shared_key (v__algs: t13.Tls13crypto.t_Algorithms) =
  match
    t13.Tls13utils.encode_length_u16 (t13.Tls13utils.bytes2 0uy 0uy
        <:
        t13.Tls13utils.t_Bytes)
  with
  | Core.Result.Result_Ok hoist67 ->
    Core.Result.Result_Ok
    (t13.Tls13utils.impl__Bytes__concat (t13.Tls13utils.bytes2 0uy 41uy
          <:
          t13.Tls13utils.t_Bytes)
        hoist67)
    <:
...
let server_supported_version (v__algorithms: t13.Tls13crypto.t_Algorithms) =
  match
    t13.Tls13utils.encode_length_u16 (t13.Tls13utils.bytes2 3uy 4uy
        <:
        t13.Tls13utils.t_Bytes)
  with
  | Core.Result.Result_Ok hoist69 ->
    Core.Result.Result_Ok
    (t13.Tls13utils.impl__Bytes__prefix hoist69
...
let signature_algorithms (algs: t13.Tls13crypto.t_Algorithms) =
  ...
  | Core.Result.Result_Ok hoist71 ->
    (match t13.Tls13utils.encode_length_u16 hoist71 with
      | Core.Result.Result_Ok hoist73 ->
        (match t13.Tls13utils.encode_length_u16 hoist73 with
          | Core.Result.Result_Ok hoist75 ->
            Core.Result.Result_Ok
            (t13.Tls13utils.impl__Bytes__concat (t13.Tls13utils.bytes2 0uy 13uy
                  <:
                  t13.Tls13utils.t_Bytes)
                hoist75)
            <:
...
let supported_groups (algs: t13.Tls13crypto.t_Algorithms) =
  ...
  | Core.Result.Result_Ok hoist77 ->
    (match t13.Tls13utils.encode_length_u16 hoist77 with
      | Core.Result.Result_Ok hoist79 ->
        (match t13.Tls13utils.encode_length_u16 hoist79 with
          | Core.Result.Result_Ok hoist81 ->
            Core.Result.Result_Ok
            (t13.Tls13utils.impl__Bytes__prefix hoist81
...
let ecdsa_signature (sv: t13.Tls13utils.t_Bytes) =
  if (t13.Tls13utils.impl__Bytes__len sv <: usize) <>. sz 64
  then
    Core.Result.Result_Err (t13.Tls13utils.parse_failed ())
    <:
    Core.Result.t_Result t13.Tls13utils.t_Bytes u8
    ...
    let (r: t13.Tls13utils.t_Bytes):t13.Tls13utils.t_Bytes =
      t13.Tls13utils.impl__Bytes__slice sv (sz 0) (sz 32)
    in
    let (s: t13.Tls13utils.t_Bytes):t13.Tls13utils.t_Bytes =
      t13.Tls13utils.impl__Bytes__slice sv (sz 32) (sz 32)
    in
    let r:t13.Tls13utils.t_Bytes =
      if (t13.Tls13utils.f_declassify (r.[ sz 0 ] <: u8) <: u8) >=. 128uy
      then
        let r:t13.Tls13utils.t_Bytes =
          t13.Tls13utils.impl__Bytes__concat (Core.Clone.f_clone b0 <: t13.Tls13utils.t_Bytes)
            r
        in
        r
      else r
    in
    let s:t13.Tls13utils.t_Bytes =
      if (t13.Tls13utils.f_declassify (s.[ sz 0 ] <: u8) <: u8) >=. 128uy
      then
        let s:t13.Tls13utils.t_Bytes = t13.Tls13utils.impl__Bytes__concat b0 s in
        s
      else s
    in
    match
      t13.Tls13utils.encode_length_u8 (t13.Tls13utils.impl__Bytes__as_raw r <: t_Slice u8)
    with
    | Core.Result.Result_Ok hoist83 ->
      (match
          t13.Tls13utils.encode_length_u8 (t13.Tls13utils.impl__Bytes__as_raw s <: t_Slice u8)
        with
        | Core.Result.Result_Ok hoist85 ->
          (match
              t13.Tls13utils.encode_length_u8 (t13.Tls13utils.impl__Bytes__as_raw (t13.Tls13utils.impl__Bytes__concat
                        (t13.Tls13utils.impl__Bytes__concat (t13.Tls13utils.impl__Bytes__concat
                                (Core.Clone.f_clone b2 <: t13.Tls13utils.t_Bytes)
                                hoist83
                              <:
                              t13.Tls13utils.t_Bytes)
                            b2
            ...
            | Core.Result.Result_Ok hoist90 ->
              Core.Result.Result_Ok (t13.Tls13utils.impl__Bytes__concat b1 hoist90)
              <:
              Core.Result.t_Result t13.Tls13utils.t_Bytes u8
            | Core.Result.Result_Err err ->
              Core.Result.Result_Err err <: Core.Result.t_Result t13.Tls13utils.t_Bytes u8)
...
let pre_shared_key
     ...
     =
  match
    t13.Tls13utils.encode_length_u16 (Core.Clone.f_clone session_ticket
        <:
        t13.Tls13utils.t_Bytes)
  with
  | Core.Result.Result_Ok hoist92 ->
    (match
        t13.Tls13utils.encode_length_u16 (t13.Tls13utils.impl__Bytes__concat_array (sz 4)
              hoist92
              (t13.Tls13utils.u32_as_be_bytes (t13.Tls13utils.v_U32 4294967295ul <: u32)
                <:
                t_Array u8 (sz 4))
            <:
            t13.Tls13utils.t_Bytes)
      ...
      | Core.Result.Result_Ok identities ->
        (match
            t13.Tls13utils.encode_length_u8 (t13.Tls13utils.impl__Bytes__as_raw (t13.Tls13crypto.zero_key
                      (t13.Tls13crypto.impl__Algorithms__hash algs
                        <:
          ...
          | Core.Result.Result_Ok hoist95 ->
            (match t13.Tls13utils.encode_length_u16 hoist95 with
              | Core.Result.Result_Ok binders ->
                let binders_len:usize = t13.Tls13utils.impl__Bytes__len binders in
                (match
                    t13.Tls13utils.encode_length_u16 (t13.Tls13utils.impl__Bytes__concat identities
                          binders
                        <:
                        t13.Tls13utils.t_Bytes)
                  with
                  | Core.Result.Result_Ok hoist97 ->
                    let ext:t13.Tls13utils.t_Bytes =
                      t13.Tls13utils.impl__Bytes__concat (t13.Tls13utils.bytes2 0uy 41uy
                        ...
                        hoist97
                    in
                    Core.Result.Result_Ok (ext, binders_len <: (t13.Tls13utils.t_Bytes & usize))
                    <:
...
let psk_key_exchange_modes (_: Prims.unit) =
  ...
  | Core.Result.Result_Ok hoist98 ->
    (match t13.Tls13utils.encode_length_u16 hoist98 with
      | Core.Result.Result_Ok hoist100 ->
        Core.Result.Result_Ok
        (t13.Tls13utils.impl__Bytes__prefix hoist100
...
let supported_versions (_: Prims.unit) =
  ...
  | Core.Result.Result_Ok hoist102 ->
    (match t13.Tls13utils.encode_length_u16 hoist102 with
      | Core.Result.Result_Ok hoist104 ->
        Core.Result.Result_Ok
        (t13.Tls13utils.impl__Bytes__concat (Core.Convert.f_from (let list = [0uy; 43uy] in
                  FStar.Pervasives.assert_norm (Prims.eq2 (List.Tot.length list) 2);
                  Rust_primitives.Hax.array_of_list 2 list)
              <:
              t13.Tls13utils.t_Bytes)
...
let check_handshake_record (p: t13.Tls13utils.t_Bytes) =
  Rust_primitives.Hax.Control_flow_monad.Mexception.run (if
        (t13.Tls13utils.impl__Bytes__len p <: usize) <. sz 5 <: bool
      then
        Core.Ops.Control_flow.ControlFlow_Continue
        ...
        let ty:t13.Tls13utils.t_Bytes =
          t13.Tls13utils.bytes1 (cast (discriminant_ContentType_Handshake +! 0uy <: u8) <: u8)
        in
        let ver:t13.Tls13utils.t_Bytes = t13.Tls13utils.bytes2 3uy 3uy in
        let! _:Prims.unit =
          match
            t13.Tls13utils.check_eq ty
              (t13.Tls13utils.impl__Bytes__slice_range p
                  ({ Core.Ops.Range.f_start = sz 0; Core.Ops.Range.f_end = sz 1 }
                    <:
                    Core.Ops.Range.t_Range usize)
                <:
        ...
        (match
            t13.Tls13utils.length_u16_encoded (p.[ {
                    Core.Ops.Range.f_start = sz 3;
                    Core.Ops.Range.f_end = t13.Tls13utils.impl__Bytes__len p <: usize
                  }
                  <:
                  Core.Ops.Range.t_Range usize ]
                <:
...
let client_hello
     ...
     =
  let version:t13.Tls13utils.t_Bytes = t13.Tls13utils.bytes2 3uy 3uy in
  let compression_methods:t13.Tls13utils.t_Bytes = t13.Tls13utils.bytes2 1uy 0uy in
  match
    t13.Tls13utils.encode_length_u8 (Rust_primitives.unsize (Rust_primitives.Hax.repeat (t13.Tls13utils.v_U8
                  0uy
                <:
                u8)
              (sz 32)
  ...
  | Core.Result.Result_Ok legacy_session_id ->
    (match t13.Tls13crypto.impl__Algorithms__ciphersuite algorithms with
      | Core.Result.Result_Ok hoist144 ->
        (match t13.Tls13utils.encode_length_u16 hoist144 with
                          ...
                          | Core.Result.Result_Ok signature_algorithms ->
                            (match
                                key_shares algorithms
                                  (Core.Clone.f_clone kem_pk <: t13.Tls13utils.t_Bytes)
                              with
                              | Core.Result.Result_Ok key_shares ->
                                let len:usize =
                                  (t13.Tls13utils.impl__Bytes__len server_name <: usize) +!
                                  (t13.Tls13utils.impl__Bytes__len supported_versions <: usize)
                                in
                                let len:usize =
                                  len +!
                                  (t13.Tls13utils.impl__Bytes__len supported_groups <: usize)
                                in
                                let len:usize =
                                  len +!
                                  (t13.Tls13utils.impl__Bytes__len signature_algorithms <: usize)
                                in
                                let len:usize =
                                  len +! (t13.Tls13utils.impl__Bytes__len key_shares <: usize)
                                in
                                let out:t13.Tls13utils.t_Bytes =
                                  t13.Tls13utils.impl__Bytes__new_alloc len
                                in
                                let out:t13.Tls13utils.t_Bytes =
                                  t13.Tls13utils.impl__Bytes__append out server_name
                                in
                                let out:t13.Tls13utils.t_Bytes =
                                  t13.Tls13utils.impl__Bytes__append out supported_versions
                                in
                                let out:t13.Tls13utils.t_Bytes =
                                  t13.Tls13utils.impl__Bytes__append out supported_groups
                                in
                                let out:t13.Tls13utils.t_Bytes =
                                  t13.Tls13utils.impl__Bytes__append out signature_algorithms
                                in
                                let out:t13.Tls13utils.t_Bytes =
...
let encrypted_extensions (v__algs: t13.Tls13crypto.t_Algorithms) =
  let handshake_type:t13.Tls13utils.t_Bytes =
    t13.Tls13utils.bytes1 (cast (t13.Tls13formats.Handshake_data.discriminant_HandshakeType_EncryptedExtensions +!
            0uy
            <:
            u8)
        <:
  ...
  in
  match
    t13.Tls13utils.encode_length_u16 (t13.Tls13utils.impl__Bytes__new ()
        <:
        t13.Tls13utils.t_Bytes)
  with
  | Core.Result.Result_Ok hoist146 ->
    (match t13.Tls13utils.encode_length_u24 hoist146 with
      | Core.Result.Result_Ok hoist148 ->
        Core.Result.Result_Ok
        (t13.Tls13formats.Handshake_data.HandshakeData
          (t13.Tls13utils.impl__Bytes__concat handshake_type hoist148)
          <:
          t13.Tls13formats.Handshake_data.t_HandshakeData)
        <:
        Core.Result.t_Result t13.Tls13formats.Handshake_data.t_HandshakeData u8
...
let rec find_key_share (g: t13.Tls13utils.t_Bytes) (ch: t_Slice u8) =
  ...
  then t13.Tls13utils.tlserr (t13.Tls13utils.parse_failed () <: u8)
    ...
    if
      t13.Tls13utils.eq_slice (t13.Tls13utils.impl__Bytes__as_raw g <: t_Slice u8)
...
let get_handshake_record (p: t13.Tls13utils.t_Bytes) =
  ...
  | Core.Result.Result_Ok (hd, len) ->
    if len =. (t13.Tls13utils.impl__Bytes__len p <: usize)
    then
...
let handshake_record (p: t13.Tls13formats.Handshake_data.t_HandshakeData) =
  ...
  in
  let ver:t13.Tls13utils.t_Bytes = t13.Tls13utils.bytes2 3uy 3uy in
  match t13.Tls13utils.encode_length_u16 p.t13.Tls13formats.Handshake_data._0 with
  | Core.Result.Result_Ok hoist156 ->
    Core.Result.Result_Ok
    (t13.Tls13utils.impl__Bytes__concat (t13.Tls13utils.impl__Bytes__concat ty ver
          <:
          t13.Tls13utils.t_Bytes)
        hoist156)
    <:
...
let parse_certificate_verify
     ...
     =
  match
    t13.Tls13formats.Handshake_data.impl__HandshakeData__as_handshake_message certificate_verify
          ...
          | Core.Result.Result_Ok _ ->
            (match
              ...
              | Core.Result.Result_Ok _ ->
                (match sa with
                  | t13.Tls13crypto.SignatureScheme_EcdsaSecp256r1Sha256  ->
                    parse_ecdsa_signature (t13.Tls13utils.impl__Bytes__slice_range cv
                          ({
                              Core.Ops.Range.f_start = sz 4;
                              Core.Ops.Range.f_end = t13.Tls13utils.impl__Bytes__len cv <: usize
                            }
                  ...
                  | t13.Tls13crypto.SignatureScheme_RsaPssRsaSha256  ->
                    ...
                    Core.Result.t_Result t13.Tls13utils.t_Bytes u8
                  | t13.Tls13crypto.SignatureScheme_ED25519  ->
                    if ((t13.Tls13utils.impl__Bytes__len cv <: usize) -! sz 4 <: usize) =. sz 64
                    then
                      Core.Result.Result_Ok
                      (t13.Tls13utils.impl__Bytes__slice_range cv
                          ({
...
let parse_encrypted_extensions
      (v__algs: t13.Tls13crypto.t_Algorithms)
  ...
  | Core.Result.Result_Ok _ ->
    t13.Tls13utils.check_length_encoding_u24 (t13.Tls13utils.impl__Bytes__raw_slice encrypted_extension_bytes
          ({
              ...
              Core.Ops.Range.f_end
              =
              t13.Tls13utils.impl__Bytes__len encrypted_extension_bytes <: usize
            }
            <:
            Core.Ops.Range.t_Range usize)
        <:
...
let parse_finished (finished: t13.Tls13formats.Handshake_data.t_HandshakeData) =
  match
    t13.Tls13formats.Handshake_data.impl__HandshakeData__as_handshake_message finished
...
let parse_server_certificate (certificate: t13.Tls13formats.Handshake_data.t_HandshakeData) =
  match
    t13.Tls13formats.Handshake_data.impl__HandshakeData__as_handshake_message certificate
  ...
  | Core.Result.Result_Ok (t13.Tls13formats.Handshake_data.HandshakeData sc) ->
    ...
    (match
      ...
      | Core.Result.Result_Ok creqlen ->
        ...
        (match
            t13.Tls13utils.check_length_encoding_u24 (t13.Tls13utils.impl__Bytes__raw_slice sc
                  ({
          ...
          | Core.Result.Result_Ok _ ->
            ...
            (match
                t13.Tls13utils.length_u24_encoded (t13.Tls13utils.impl__Bytes__raw_slice sc
                      ({
                          Core.Ops.Range.f_start = next;
                          Core.Ops.Range.f_end = t13.Tls13utils.impl__Bytes__len sc <: usize
                        }
              ...
              | Core.Result.Result_Ok crtlen ->
                ...
                let crt:t13.Tls13utils.t_Bytes =
                  t13.Tls13utils.impl__Bytes__slice_range sc
                    ({
                        Core.Ops.Range.f_start = next;
...
let server_certificate (v__algs: t13.Tls13crypto.t_Algorithms) (cert: t13.Tls13utils.t_Bytes) =
  match
    t13.Tls13utils.encode_length_u8 (Rust_primitives.unsize (let list:Prims.list u8 = [] in
  ...
  | Core.Result.Result_Ok creq ->
    (match t13.Tls13utils.encode_length_u24 cert with
      | Core.Result.Result_Ok crt ->
        (match
          ...
          | Core.Result.Result_Ok ext ->
            (match
                t13.Tls13utils.encode_length_u24 (t13.Tls13utils.impl__Bytes__concat crt ext
                    <:
                    t13.Tls13utils.t_Bytes)
              with
              | Core.Result.Result_Ok crts ->
                t13.Tls13formats.Handshake_data.impl__HandshakeData__from_bytes (t13.Tls13formats.Handshake_data.HandshakeType_Certificate
                    <:
                    t13.Tls13formats.Handshake_data.t_HandshakeType)
                  (t13.Tls13utils.impl__Bytes__concat creq crts <: t13.Tls13utils.t_Bytes)
              | Core.Result.Result_Err err ->
                Core.Result.Result_Err err
                <:
                Core.Result.t_Result t13.Tls13formats.Handshake_data.t_HandshakeData u8)
...
let set_client_hello_binder
  ...
  =
    client_hello
  in
  let chlen:usize = t13.Tls13utils.impl__Bytes__len ch in
  let hlen:usize =
    t13.Tls13crypto.impl__HashAlgorithm__hash_len (t13.Tls13crypto.impl__Algorithms__hash ciphersuite
  ...
  | Core.Option.Option_Some m, Core.Option.Option_Some trunc_len ->
    ...
    then
      Core.Result.Result_Ok
      (t13.Tls13formats.Handshake_data.HandshakeData
        (t13.Tls13utils.impl__Bytes__update_slice ch trunc_len m (sz 0) hlen)
        <:
        t13.Tls13formats.Handshake_data.t_HandshakeData)
      <:
      Core.Result.t_Result t13.Tls13formats.Handshake_data.t_HandshakeData u8
  ...
  | Core.Option.Option_None , Core.Option.Option_None  ->
    ...
    <:
    Core.Result.t_Result t13.Tls13formats.Handshake_data.t_HandshakeData u8
  | _, _ -> t13.Tls13utils.tlserr (t13.Tls13utils.parse_failed () <: u8)
  ...
  let self:t_Transcript =
    {
      ...
      f_transcript
      =
      t13.Tls13formats.Handshake_data.impl__HandshakeData__concat self.f_transcript msg
    }
    <:
    t_Transcript
  in
...
let impl__Transcript__new (hash_algorithm: t13.Tls13crypto.t_HashAlgorithm) =
  {
    f_hash_algorithm = hash_algorithm;
    f_transcript
    =
    t13.Tls13formats.Handshake_data.HandshakeData (t13.Tls13utils.impl__Bytes__new ())
    <:
    t13.Tls13formats.Handshake_data.t_HandshakeData
  }
  <:
...
let impl__Transcript__transcript_hash_without_client_hello
  ...
  t13.Tls13crypto.impl__HashAlgorithm__hash self.f_hash_algorithm
    (t13.Tls13utils.impl__Bytes__concat (Core.Clone.f_clone self.f_transcript
          ...
          <:
          t13.Tls13utils.t_Bytes)
        (t13.Tls13utils.impl__Bytes__slice_range client_hello
              .t13.Tls13formats.Handshake_data._0
...
let check_extensions (algs: t13.Tls13crypto.t_Algorithms) (b: t13.Tls13utils.t_Bytes) =
  match check_extension algs (t13.Tls13utils.impl__Bytes__as_raw b <: t_Slice u8) with
  | Core.Result.Result_Ok (len, out) ->
      ...
      (match
          check_extensions_slice algs
            (t13.Tls13utils.impl__Bytes__raw_slice b
                ({
                    Core.Ops.Range.f_start = len;
                    Core.Ops.Range.f_end = t13.Tls13utils.impl__Bytes__len b <: usize
                  }
                  <:
                  Core.Ops.Range.t_Range usize)
              <:
          ...
          | Core.Result.Result_Ok _ ->
            ...
            (match
                t13.Tls13utils.length_u8_encoded (ch.[ {
                        Core.Ops.Range.f_start = next;
                        Core.Ops.Range.f_end = t13.Tls13utils.impl__Bytes__len ch <: usize
                      }
                      <:
                      Core.Ops.Range.t_Range usize ]
                    <:
              ...
              | Core.Result.Result_Ok sidlen ->
                ...
                let next:usize = (next +! sz 1 <: usize) +! sidlen in
                (match
                    t13.Tls13crypto.impl__Algorithms__check ciphersuite
                      (t13.Tls13utils.impl__Bytes__raw_slice ch
                          ({
                              Core.Ops.Range.f_start = next;
                              Core.Ops.Range.f_end = t13.Tls13utils.impl__Bytes__len ch <: usize
                            }
