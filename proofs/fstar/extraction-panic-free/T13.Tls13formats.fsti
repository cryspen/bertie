...
let build_server_name__PREFIX1: t_Array u8 (sz 2) =
  let list = [t13.Tls13utils.v_U8 0uy; t13.Tls13utils.v_U8 0uy] in
  FStar.Pervasives.assert_norm (Prims.eq2 (List.Tot.length list) 2);
  Rust_primitives.Hax.array_of_list 2 list

let build_server_name__PREFIX2: t_Array u8 (sz 1) =
  let list = [t13.Tls13utils.v_U8 0uy] in
  FStar.Pervasives.assert_norm (Prims.eq2 (List.Tot.length list) 1);
  Rust_primitives.Hax.array_of_list 1 list

let key_shares__PREFIX: t_Array u8 (sz 2) =
  let list = [t13.Tls13utils.v_U8 0uy; t13.Tls13utils.v_U8 51uy] in
  FStar.Pervasives.assert_norm (Prims.eq2 (List.Tot.length list) 2);
  Rust_primitives.Hax.array_of_list 2 list

let psk_key_exchange_modes__PSK_MODE_PREFIX: t_Array u8 (sz 2) =
  let list = [t13.Tls13utils.v_U8 0uy; t13.Tls13utils.v_U8 45uy] in
  FStar.Pervasives.assert_norm (Prims.eq2 (List.Tot.length list) 2);
  Rust_primitives.Hax.array_of_list 2 list

let server_supported_version__SUPPORTED_VERSION_PREFIX: t_Array u8 (sz 2) =
  let list = [t13.Tls13utils.v_U8 0uy; t13.Tls13utils.v_U8 43uy] in
  FStar.Pervasives.assert_norm (Prims.eq2 (List.Tot.length list) 2);
  Rust_primitives.Hax.array_of_list 2 list

let supported_groups__SUPPORTED_GROUPS_PREFIX: t_Array u8 (sz 2) =
  let list = [t13.Tls13utils.v_U8 0uy; t13.Tls13utils.v_U8 10uy] in
  FStar.Pervasives.assert_norm (Prims.eq2 (List.Tot.length list) 2);
  Rust_primitives.Hax.array_of_list 2 list
...
val check_psk_shared_key (v__algs: t13.Tls13crypto.t_Algorithms) (ch: t_Slice u8)
    : Prims.Pure (Core.Result.t_Result Prims.unit u8) Prims.l_True (fun _ -> Prims.l_True)

val check_server_psk_shared_key (v__algs: t13.Tls13crypto.t_Algorithms) (b: t_Slice u8)
    : Prims.Pure (Core.Result.t_Result Prims.unit u8) Prims.l_True (fun _ -> Prims.l_True)

val check_server_supported_version (v__algs: t13.Tls13crypto.t_Algorithms) (b: t_Slice u8)
    : Prims.Pure (Core.Result.t_Result Prims.unit u8) Prims.l_True (fun _ -> Prims.l_True)
...
val server_supported_version (v__algorithms: t13.Tls13crypto.t_Algorithms)
    : Prims.Pure (Core.Result.t_Result t13.Tls13utils.t_Bytes u8)
      Prims.l_True
      (fun _ -> Prims.l_True)
...
val server_certificate (v__algs: t13.Tls13crypto.t_Algorithms) (cert: t13.Tls13utils.t_Bytes)
    : Prims.Pure (Core.Result.t_Result t13.Tls13formats.Handshake_data.t_HandshakeData u8)
      Prims.l_True
      (fun _ -> Prims.l_True)
...
val impl__Transcript__new (hash_algorithm: t13.Tls13crypto.t_HashAlgorithm)
    : Prims.Pure t_Transcript Prims.l_True (fun _ -> Prims.l_True)
