      ...
      (ensures
        fun result ->
          ...
          | Core.Result.Result_Ok _ ->
            (t13.Tls13utils.impl_Bytes__len b <: usize) >=. offset &&
            ((t13.Tls13utils.impl_Bytes__len b <: usize) -! offset <: usize) >=. len
          | _ -> true)
      ...
      (ensures
        fun result ->
          ...
          | Core.Result.Result_Ok l ->
            (t13.Tls13utils.impl_Bytes__len b <: usize) >. offset && l <=. mk_usize 255
          | _ -> true)
    ...
    : Prims.Pure (Core.Result.t_Result usize u8)
      ...
      (ensures
        fun result ->
          let result:Core.Result.t_Result usize u8 = result in
          match result <: Core.Result.t_Result usize u8 with
          | Core.Result.Result_Ok _ -> (t13.Tls13utils.impl_Bytes__len b <: usize) >. offset
          | _ -> true)
