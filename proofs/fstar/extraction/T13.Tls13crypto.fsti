...
val hash (ha: t_HashAlgorithm) (data: t13.Tls13utils.t_Bytes)
...
val impl_AeadKeyIV__new (key: t_AeadKey) (iv: t13.Tls13utils.t_Bytes)
    : Prims.Pure t_AeadKeyIV Prims.l_True (fun _ -> Prims.l_True)

/// Create a new AEAD key from the raw bytes and the algorithm.
val impl_AeadKey__new (bytes: t13.Tls13utils.t_Bytes) (e_alg: t_AeadAlgorithm)
    ...
    : Prims.Pure (Core.Result.t_Result t13.Tls13utils.t_Bytes u8)
      ...
      (ensures
        fun result ->
          ...
          | Core.Result.Result_Ok b -> (t13.Tls13utils.impl_Bytes__len b <: usize) =. mk_usize 2
