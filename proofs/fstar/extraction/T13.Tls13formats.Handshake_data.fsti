...
[@@ FStar.Tactics.Typeclasses.tcinstance]
val impl_6:Core.Convert.t_From t_HandshakeData t13.Tls13utils.t_Bytes

val from_bytes_inner (handshake_type: t_HandshakeType) (handshake_bytes: t13.Tls13utils.t_Bytes)
    : Prims.Pure (Core.Result.t_Result t_HandshakeData u8)
      Prims.l_True
      (ensures
        fun result ->
          ...
          | Core.Result.Result_Ok hd ->
            ...
            (t13.Tls13utils.impl_Bytes__len handshake_bytes <: usize)
          | _ -> true)
