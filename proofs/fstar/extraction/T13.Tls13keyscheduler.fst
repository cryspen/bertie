...
let hash_empty (algorithm: t13.Tls13crypto.t_HashAlgorithm) =
  t13.Tls13crypto.hash algorithm
...
let derive_binder_key
  ...
  let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
    ...
    t13.Tls13keyscheduler.Key_schedule.zero_salt ks ha
  in
  let ks:t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler = tmp0 in
  let zero_salt_handle:t13.Tls13keyscheduler.Key_schedule.t_Handle = out in
  let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
    Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8) =
    t13.Tls13keyscheduler.Key_schedule.v_XTR ks
      (mk_u8 0)
      (t13.Tls13keyscheduler.Key_schedule.TLSnames_ES
        <:
  ...
  | Core.Result.Result_Ok early_secret ->
    (match hash_empty ha <: Core.Result.t_Result t13.Tls13utils.t_Bytes u8 with
      | Core.Result.Result_Ok hoist137 ->
        let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
          Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8) =
          t13.Tls13keyscheduler.Key_schedule.v_XPD ks
            (t13.Tls13keyscheduler.Key_schedule.TLSnames_Bind
              <:
              t13.Tls13keyscheduler.Key_schedule.t_TLSnames)
            (mk_u8 0)
            early_secret
        ...
        in
        let ks:t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler = tmp0 in
        let hax_temp_output:Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8 =
          out
        in
        ks, hax_temp_output
        <:
...
let derive_aead_key_iv
     ...
     =
  match
    t13.Tls13keyscheduler.Key_schedule.tagkey_from_handle ks handle
    <:
    Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_TagKey u8
  with
  | Core.Result.Result_Ok hoist138 ->
    let key:t13.Tls13utils.t_Bytes = hoist138.t13.Tls13keyscheduler.Key_schedule.f_val in
    (match
        t13.Tls13keyscheduler.Key_schedule.hkdf_expand_label hash_algorithm
          key
          (t13.Tls13utils.bytes (t13.Tls13formats.v_LABEL_KEY <: t_Slice u8)
            <:
            t13.Tls13utils.t_Bytes)
          (t13.Tls13utils.impl_Bytes__new () <: t13.Tls13utils.t_Bytes)
          (t13.Tls13crypto.impl_AeadAlgorithm__key_len aead_algorithm <: usize)
        <:
      ...
      | Core.Result.Result_Ok sender_write_key ->
        (match
            t13.Tls13keyscheduler.Key_schedule.hkdf_expand_label hash_algorithm
              key
              (t13.Tls13utils.bytes (t13.Tls13formats.v_LABEL_IV <: t_Slice u8)
                <:
                t13.Tls13utils.t_Bytes)
              (t13.Tls13utils.impl_Bytes__new () <: t13.Tls13utils.t_Bytes)
              (t13.Tls13crypto.impl_AeadAlgorithm__iv_len aead_algorithm <: usize)
            <:
            Core.Result.t_Result t13.Tls13utils.t_Bytes u8
          with
          | Core.Result.Result_Ok sender_write_iv ->
            let hax_temp_output:Core.Result.t_Result t13.Tls13crypto.t_AeadKeyIV u8 =
              Core.Result.Result_Ok
              (t13.Tls13crypto.impl_AeadKeyIV__new (t13.Tls13crypto.impl_AeadKey__new sender_write_key
                      aead_algorithm
                    <:
          ...
          | Core.Result.Result_Err err ->
            ...
            (t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
              Core.Result.t_Result t13.Tls13crypto.t_AeadKeyIV u8))
      | Core.Result.Result_Err err ->
        ks, (Core.Result.Result_Err err <: Core.Result.t_Result t13.Tls13crypto.t_AeadKeyIV u8)
        <:
        (t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
          Core.Result.t_Result t13.Tls13crypto.t_AeadKeyIV u8))
  | Core.Result.Result_Err err ->
...
let next_keys_c_2_
  ...
  let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
    t13.Tls13keyscheduler.Key_schedule.t_Handle) =
    t13.Tls13keyscheduler.Key_schedule.zero_salt ks hash_algorithm
  in
  let ks:t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler = tmp0 in
  let zero_salt_handle:t13.Tls13keyscheduler.Key_schedule.t_Handle = out in
  let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
  ...
  match out <: Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8 with
  | Core.Result.Result_Ok early_secret ->
    (match hash_empty hash_algorithm <: Core.Result.t_Result t13.Tls13utils.t_Bytes u8 with
      | Core.Result.Result_Ok digest_emp ->
        let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
          Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8) =
          t13.Tls13keyscheduler.Key_schedule.v_XPD ks
            (t13.Tls13keyscheduler.Key_schedule.TLSnames_ESalt
              <:
              t13.Tls13keyscheduler.Key_schedule.t_TLSnames)
            (mk_u8 0)
            early_secret
        ...
        (match out <: Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8 with
          | Core.Result.Result_Ok derived_secret ->
            let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
              Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8) =
              t13.Tls13keyscheduler.Key_schedule.v_XPD ks
                (t13.Tls13keyscheduler.Key_schedule.TLSnames_CET
                  <:
                  t13.Tls13keyscheduler.Key_schedule.t_TLSnames)
                (mk_u8 0)
                early_secret
            ...
            (match
              ...
              | Core.Result.Result_Ok client_early_traffic_secret ->
                let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
                  Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8) =
                  t13.Tls13keyscheduler.Key_schedule.v_XPD ks
                    (t13.Tls13keyscheduler.Key_schedule.TLSnames_EEM
                      <:
                      t13.Tls13keyscheduler.Key_schedule.t_TLSnames)
                    (mk_u8 0)
                    early_secret
...
let derive_0rtt_keys
  ...
  | Core.Result.Result_Ok
    ...
    in
    let ks:t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler = tmp0 in
    (match out <: Core.Result.t_Result t13.Tls13crypto.t_AeadKeyIV u8 with
      | Core.Result.Result_Ok sender_write_key_iv ->
        let hax_temp_output:Core.Result.t_Result
          ...
          (sender_write_key_iv, early_exporter_master_secret
            <:
            (t13.Tls13crypto.t_AeadKeyIV & t13.Tls13keyscheduler.Key_schedule.t_Handle))
          <:
          Core.Result.t_Result
            (t13.Tls13crypto.t_AeadKeyIV & t13.Tls13keyscheduler.Key_schedule.t_Handle) u8
        in
...
let derive_finished_key
  ...
  | Core.Result.Result_Ok k ->
    let hax_temp_output:Core.Result.t_Result t13.Tls13utils.t_Bytes u8 =
      t13.Tls13keyscheduler.Key_schedule.hkdf_expand_label ha
        k.t13.Tls13keyscheduler.Key_schedule.f_val
        (t13.Tls13utils.bytes (t13.Tls13formats.v_LABEL_FINISHED <: t_Slice u8)
          <:
          t13.Tls13utils.t_Bytes)
        (t13.Tls13utils.impl_Bytes__new () <: t13.Tls13utils.t_Bytes)
        (t13.Tls13crypto.impl_HashAlgorithm__hmac_tag_len ha <: usize)
    in
    ks, hax_temp_output
    <:
    (t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
      Core.Result.t_Result t13.Tls13utils.t_Bytes u8)
  | Core.Result.Result_Err err ->
    ks, (Core.Result.Result_Err err <: Core.Result.t_Result t13.Tls13utils.t_Bytes u8)
    <:
    (t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
      Core.Result.t_Result t13.Tls13utils.t_Bytes u8)
...
let derive_hk_handles
  ...
  let ks, psk_handle:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
    t13.Tls13keyscheduler.Key_schedule.t_Handle) =
    match psko <: Core.Option.t_Option t13.Tls13keyscheduler.Key_schedule.t_Handle with
    | Core.Option.Option_Some k ->
      ks,
      Core.Clone.f_clone #t13.Tls13keyscheduler.Key_schedule.t_Handle
    ...
    | _ ->
      let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
        t13.Tls13keyscheduler.Key_schedule.t_Handle) =
        t13.Tls13keyscheduler.Key_schedule.no_psk ks ha
      in
      let ks:t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler = tmp0 in
      ks, out
      <:
        ...
        (match out <: Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8 with
          | Core.Result.Result_Ok derived_secret ->
            let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
              ...
              t13.Tls13keyscheduler.Key_schedule.v_XTR ks
                (mk_u8 0)
                (t13.Tls13keyscheduler.Key_schedule.TLSnames_HS
                  <:
                  t13.Tls13keyscheduler.Key_schedule.t_TLSnames)
                shared_secret
                derived_secret
            ...
            (match
              ...
              | Core.Result.Result_Ok handshake_secret ->
                let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
                  Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8) =
                  t13.Tls13keyscheduler.Key_schedule.v_XPD ks
                    (t13.Tls13keyscheduler.Key_schedule.TLSnames_CHT
                      <:
                      t13.Tls13keyscheduler.Key_schedule.t_TLSnames)
                    (mk_u8 0)
                    handshake_secret
                ...
                (match
                  ...
                  | Core.Result.Result_Ok client_handshake_traffic_secret ->
                    let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
                      Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8) =
                      t13.Tls13keyscheduler.Key_schedule.v_XPD ks
                        (t13.Tls13keyscheduler.Key_schedule.TLSnames_SHT
                          <:
                          t13.Tls13keyscheduler.Key_schedule.t_TLSnames)
                        (mk_u8 0)
                        handshake_secret
                    ...
                    (match
                      ...
                      | Core.Result.Result_Ok server_handshake_traffic_secret ->
                        let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
                          Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8) =
                          t13.Tls13keyscheduler.Key_schedule.v_XPD ks
                            (t13.Tls13keyscheduler.Key_schedule.TLSnames_HSalt
                              <:
                              t13.Tls13keyscheduler.Key_schedule.t_TLSnames)
                            (mk_u8 0)
                            handshake_secret
                        ...
                        (match
                          ...
                          | Core.Result.Result_Ok master_secret_ ->
                            let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
                              t13.Tls13keyscheduler.Key_schedule.t_Handle) =
                              t13.Tls13keyscheduler.Key_schedule.zero_ikm ks ha
                            in
                            let ks:t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler = tmp0 in
                            let zero_ikm_handle:t13.Tls13keyscheduler.Key_schedule.t_Handle =
                              out
                            in
                            let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
                              Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8
                              ...
                              t13.Tls13keyscheduler.Key_schedule.v_XTR ks
                                (mk_u8 0)
                                (t13.Tls13keyscheduler.Key_schedule.TLSnames_AS
                                  <:
                                  t13.Tls13keyscheduler.Key_schedule.t_TLSnames)
                                zero_ikm_handle
                                master_secret_
                            ...
                            (match
                                out
                                <:
                                Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle
                                  u8
                              with
...
let derive_hk_ms
  ...
  in
  let ks:t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler = tmp0 in
  match out <: Core.Result.t_Result t13.Tls13utils.t_Bytes u8 with
...
let derive_app_handles
  ...
  let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
    Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8) =
    t13.Tls13keyscheduler.Key_schedule.v_XPD ks
      (t13.Tls13keyscheduler.Key_schedule.TLSnames_CAT
        <:
        t13.Tls13keyscheduler.Key_schedule.t_TLSnames)
      (mk_u8 0)
      master_secret
  ...
  | Core.Result.Result_Ok client_application_traffic_secret_0_ ->
    let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
      Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8) =
      t13.Tls13keyscheduler.Key_schedule.v_XPD ks
        (t13.Tls13keyscheduler.Key_schedule.TLSnames_SAT
          <:
          t13.Tls13keyscheduler.Key_schedule.t_TLSnames)
        (mk_u8 0)
        master_secret
    ...
    (match out <: Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8 with
      | Core.Result.Result_Ok server_application_traffic_secret_0_ ->
        let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
          Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8) =
          t13.Tls13keyscheduler.Key_schedule.v_XPD ks
            (t13.Tls13keyscheduler.Key_schedule.TLSnames_EAM
              <:
              t13.Tls13keyscheduler.Key_schedule.t_TLSnames)
            (mk_u8 0)
            master_secret
...
let derive_rms
  ...
  let tmp0, out:(t13.Tls13keyscheduler.Key_schedule.t_TLSkeyscheduler &
    Core.Result.t_Result t13.Tls13keyscheduler.Key_schedule.t_Handle u8) =
    t13.Tls13keyscheduler.Key_schedule.v_XPD ks
      (t13.Tls13keyscheduler.Key_schedule.TLSnames_RM
        <:
        t13.Tls13keyscheduler.Key_schedule.t_TLSnames)
      (mk_u8 0)
      master_secret
